...
لطفاً یکی از موضوعات زیر را انتخاب کنید:""",
        "buttons": [
            ...
            [InlineKeyboardButton("🎁 ارسال کارت هدیه", callback_data="help_giftcard^")],
...
- امتیازهای داده شده در کانال رسمی منتشر می‌شود""",
    ...
    "giftcard": {
        "title": "🎁 راهنمای ارسال کارت هدیه",
        "text": """با استفاده از بخش کارت هدیه می‌توانید پیام‌های دلنشین خود را در قالب یک کارت هدیه زیبا برای همکاران خود ارسال کنید.

✨ روش ارسال کارت هدیه:
۱. ابتدا دستور /start را ارسال کنید
۲. روی دکمه «🎁 ارسال کارت هدیه» کلیک کنید
۳. از لیست، همکار مورد نظر خود را انتخاب کنید
۴. متن پیام خود را تایپ کنید و ارسال کنید
۵. کارت هدیه شما به صورت خودکار طراحی و برای گیرنده ارسال می‌شود

⚠️ نکات مهم:
- ارسال کارت هدیه کاملاً رایگان است و نیازی به اعتبار ندارد
- کارت هدیه‌ها به صورت خصوصی ارسال می‌شوند و در کانال عمومی منتشر نمی‌شوند
- سعی کنید پیام‌های مثبت و انگیزشی ارسال کنید
- متن‌های طولانی ممکن است به درستی در کارت هدیه نمایش داده نشوند""",
        "buttons": [
            [InlineKeyboardButton("🎁 رفتن به بخش کارت هدیه", callback_data="giftcard_start^")],
            [InlineKeyboardButton("» بازگشت به راهنما", callback_data="help^")]
        ]
    },
